...
def translate_file(input_file: typing.TextIO, output_file: typing.TextIO) -> None:
    ...
    parser, out = Parser(input_file), CodeWriter(output_file)
    out.set_file_name(input_filename)
    out.writeInit()
    while parser.has_more_commands():
        parser.advance()
        out.write_push_pop(parser.command_type(), parser.arg1(), parser.arg2())
        out.write_arithmetic(parser.arg1())
